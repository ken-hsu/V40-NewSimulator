...
#include "kalman_airspeed.h"           // Model's header file
#include "rtwtypes.h"
#include "zero_crossing_types.h"

static kalman_airspeedModelClass kalman_airspeed_Obj;// Instance of model class
...
int_T main(int_T argc, const char *argv[])
{
  ...
  // Initialize model
  kalman_airspeed_Obj.initialize();
